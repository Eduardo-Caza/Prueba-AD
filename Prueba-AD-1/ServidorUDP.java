...
public class ServidorUDP {
    private static final int PUERTO = 3001; // Puerto donde el servidor va a escuchar
    ...
    public static void main(String[] args) {
        ...
        preguntas.add(new Pregunta("¿Cuál es el idioma oficial de Brasil?", "portugues"));
        preguntas.add(new Pregunta("¿Cuántos planetas hay en el sistema solar?", "ocho"));
